...
function confirmEditUser(editUser) {
  ...
  selectedStatus.value = statuses.filter(
    (el) => el.value === editUser.compteIsVerified
  )[0];
}
      ...
      <div class="card">
        ...
        >
          ...
          <div class="field">
            ...
            <InputText
              id="firstname"
              v-model.trim="user.societe"
              required="true"
              autofocus
              :class="{ 'p-invalid': submitted && !user.societe }"
            />
            <small class="p-invalid" v-if="submitted && !user.societe"
              >Champ obligatoire.</small
            >
          </div>
          <div class="field">
            ...
            <InputText
              id="urlsite"
              v-model.trim="user.urlsite"
              required="true"
              autofocus
              :class="{ 'p-invalid': submitted && !user.urlsite }"
            />
            <small class="p-invalid" v-if="submitted && !user.urlsite"
              >Champ obligatoire.</small
            >
          </div>
          <div class="field">
          ...
          <div class="field">
            ...
            <InputText
              id="appId"
              v-model.trim="user.appId"
              required="true"
              autofocus
              :class="{ 'p-invalid': submitted && !user.appId }"
            />
            <small class="p-invalid" v-if="submitted && !user.appId"
              >Champ obligatoire.</small
            >
          </div>
          <div class="field">
